...
class widget_latestreviews extends WP_Widget {
	function __construct() {
		$widget_ops = array(
			...
			'description' => esc_html__('Display latest review posts','goodlife')
		);
		
		parent::__construct(
			'thb_latestreviews_widget',
			esc_html__( 'Fuel Themes - Latest Reviews' , 'goodlife' ),
			$widget_ops
		);
				
		$this->defaults = array( 'title' => 'Latest Reviews', 'show' => '5', 'style' => 'style1' );
	}
